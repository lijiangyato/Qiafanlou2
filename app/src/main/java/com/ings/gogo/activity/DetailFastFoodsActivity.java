...
public class DetailFastFoodsActivity extends BaseActivity implements
		OnClickListener {
	...
	public List<ImageView> points = null;
	// 图片滚动的时间
	...
	// 存放 所有图片的url的集合
	// public List<String> bgUrls = new ArrayList<String>();
	// // 获取图片的url
	...
	// private DescribByImageAdapter otherAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isRange = OtherMainPageActivity.rangers;
	...
	private void innitAllViews() {
		...
		topPage = new MyProductDetailInfoPage(DetailFastFoodsActivity.this,
				getLayoutInflater().inflate(R.layout.detaifoods_mainmsg_layout,
						null));
		bottomPage = new MyProductContentPage(DetailFastFoodsActivity.this,
		...
		progressBar = mcoySnapPageLayout.findViewById(R.id.progressbar);
	...
	private void addImage() {
		context = DetailFastFoodsActivity.this;
	...
	private void getDetailFoodsMsg() {
		...
		call.enqueue(new Callback() {
			...
			public void onResponse(final Response response) throws IOException {
				...
				LogUtils.e("所有快餐详情的商品介绍图片集合大小---->>", descPicCount + "");
