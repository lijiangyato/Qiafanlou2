...
public class DetailTormorrowCleanFoodsActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDetailFoodsName = bundle.getString("cleanFoodsName");
		mDetailFoodsPrice = bundle.getString("cleanFoodsPrice");
		mFoodsImageUrl = bundle.getString("cleanFoodsImage");
	...
	private void innitAllViews() {
		...
		topPage = new MyProductDetailInfoPage(
				DetailTormorrowCleanFoodsActivity.this, getLayoutInflater()
	...
	private void addImage() {
		context = DetailTormorrowCleanFoodsActivity.this;
