...
public class TomorrowCleanFoodsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LogUtils.e("mingri净菜的相关值----》》》", pointID + pointName + rangers);
				...
				mCleanFoodsLV.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent intent = new Intent(getApplicationContext(),
								DetailTormorrowCleanFoodsActivity.class);
						...
						bundle.putString("ShortDesc", mFastEntity.getData()
								.get((int) id).getShortdesc());
	...
	private void addImage() {
		context = TomorrowCleanFoodsActivity.this;
	...
	protected void getProductDatas() {
		...
		String trueUrl = BaseData.GET_FAST_PRODUCTS + "ponitId"
				+ "&categoryid=" + "categoryid" + "&figure=100";
		...
		call.enqueue(new Callback() {
			...
			public void onResponse(final Response response) throws IOException {
				...
				LogUtils.e("明日净菜body--->>", getProductBody);
				Gson gson = new Gson();
